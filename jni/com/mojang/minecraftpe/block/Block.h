...
public:
   ...
   virtual ~Block();
	...
	virtual bool getIgnoresDstroyPermissions(Entity&, const BlockPos&) const;
	...
	virtual void addBlockState(BlockState::BlockStates, int) const;
	virtual void resetBitsUsed() const;
	virtual void setAllowsRunes(bool) const;
